	...
	<script src="{{ asset('assets/js/waitingfor.js') }}"></script>
	<!-- endbuild -->
	...
	<script src="{{ asset('libs/bower/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
	<script src="{{ asset('libs/bower/select2/dist/js/select2.full.min.js') }}"></script>
	<script src="{{ asset('libs/misc/echarts/build/dist/echarts-all.js') }}"></script>
	<script src="{{ asset('libs/misc/echarts/build/dist/theme.js') }}"></script>
	<script src="{{ asset('libs/misc/echarts/build/dist/jquery.echarts.js') }}"></script>
